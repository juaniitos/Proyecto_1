const { createProducts, viewsProducts, viewsProductsDestacado, searchProducts, updateProducts, eliminarProduct } = require("../controllers/products.controllers");


module.exports = (app) => {
    app.post('/api/createProduct', createProducts);
    app.get('/api/products', viewsProducts);
    app.get('/api/products/destacados', viewsProductsDestacado);
